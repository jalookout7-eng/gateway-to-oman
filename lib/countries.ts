/**
 * ISO 3166-1 alpha-2 codes with international dial codes.
 * Used for the country-code dropdown on /businesses/sign-in.
 */
export interface CountryCode {
  code: string;       // ISO alpha-2 (e.g. "OM")
  name: string;       // Display name
  dial: string;       // Dial prefix without + (e.g. "968")
...
export const COUNTRY_CODES: CountryCode[] = RAW.map(([code, name, dial]) => ({
  code,
  name,
  dial,
  flag: flag(code),
...
export const DEFAULT_COUNTRY = COUNTRY_CODES.find((c) => c.code === "OM")!;
